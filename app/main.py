...
async def lifespan(app: FastAPI):
    ...
    if REFERENCE_PATH.exists():
        ...
        logger.info("startup_complete", extra={"event": "startup", "model_loaded": True, "drift_detector_ready": True})
    else:
        logger.warning("reference_missing", extra={"event": "startup", "model_loaded": True, "drift_detector_ready": False})
...
async def metrics_middleware(request: Request, call_next):
    """Універсальний middleware: міряє latency кожного HTTP-запиту."""
